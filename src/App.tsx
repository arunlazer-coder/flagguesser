  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#74ebd5] to-[#ACB6E5]">
      <div className="custom-container">
        ...
        <h1 className="custom-title after:content-[''] after:absolute after:-bottom-2 after:left-1/2 after:-translate-x-1/2 after:w-1/2 after:h-1 after:rounded bg-gradient-to-r from-[var(--primary)] to-[var(--secondary)] after:block">Flag Guesser Change Test 2</h1>
